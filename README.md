...
- name: kong-google-oauth-jwt-signer
  config:
    client_id: 012345678910-1a23b4c5dfg6hij78k9101lmn12opq3r.apps.googleusercontent.com
    client_secret: ABC-dEfghijkLmnOPqr_rst-
    jwt_validity: 86400
...
Edit `kong.conf` to permit expose environment variable `KONG_GOOGLE_OAUTH_JWT_SIGNER_PRIVATE_KEYS` to kong:
```conf
nginx_main_env=KONG_GOOGLE_OAUTH_JWT_SIGNER_PRIVATE_KEYS
```
